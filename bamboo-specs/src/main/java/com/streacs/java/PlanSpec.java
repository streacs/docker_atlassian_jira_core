...
public class PlanSpec {
    ...
    Plan createPlan() {
        return new Plan(
            project(),
            "STREACS Atlassian Jira Core", "B8E42A")
            .enabled(true)
            .noPluginConfigurations()
            .noNotifications()
            .linkedRepositories("DCK - STREACS Atlassian Jira Core (master)")
            ...
            .description("Plan created from (https://scm.streacs.com/projects/DCK/repos/streacs_atlassian_jira_core)")
            .triggers(
        ...
        return new VcsCheckoutTask()
            ...
            .checkoutItems(new CheckoutItem()
                .repository(new VcsRepositoryIdentifier()
                    .name("DCK - STREACS Atlassian Jira Core (master)")
                )
            );
    }
